...
const peopleInfo = {
  ...
  household : {
    '北京': {
      '北京市': ['东城区', '西城区', '崇文区', '宣武区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '平谷区', '怀柔区', '密云县', '延庆县', '其他']
    },
    '天津': {
      '天津市': ['和平区', '河东区', '河西区', '南开区', '河北区', '红挢区', '滨海新区', '东丽区', '西青区', '津南区', '北辰区', '宁河区', '武清区', '静海县', '宝坻区', '蓟县', '塘沽区', '汉沽区', '大港区', '宝坻区', '其他']
    },
    '河北': {
    ...
    '上海': {
      '上海市': ['黄浦区', '卢湾区', '徐汇区', '长宁区', '静安区', '普陀区', '闸北区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '奉贤区', '青浦区', '奉贤区', '崇明县', '其他']
    },
    '江苏': {
    ...
    '重庆': {
      '重庆市': ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '万盛区', '双挢区', '渝北区', '巴南区', '长寿区', '綦江县', '潼南县', '铜梁县', '大足县', '荣昌县', '壁山县', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠县', '开县', '云阳县', '奉节县', '巫山县', '巫溪县', '黔江区', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县', '江津区', '合川区', '永川区', '南川区', '其他']
    },
    '四川': {
  ...
  education : [
    "博士","硕士","本科","大专","中专和中技","技工学校","高中","初中","小学"
  ],
  political : [
  '中共党员', '中共预备党员', '共青团员','群众','农工党党员', '民革党员', '民盟盟员', '民建会员', '民进会员', '农工党党员', '致公党党员', '九三学社社员', '台盟盟员','无党派人士'
],
  blood: ['A型', 'B型', 'AB型','O型'],
...
module.exports = {
  nation: peopleInfo.nation,
  household: peopleInfo.household,
  householdNum: peopleInfo.household,
  education: peopleInfo.education,
  political: peopleInfo.political,
  blood: peopleInfo.blood,
  marriage: peopleInfo.marriage,
  faith: peopleInfo.faith,
  military: peopleInfo.military
